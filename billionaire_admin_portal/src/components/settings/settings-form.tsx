...
export default function SettingsForm({
  ...
  const {
    ...
    defaultValues: {
      ...
      // deliveryTime: settings?.deliveryTime ? settings?.deliveryTime : [] as FormValues["deliveryTime"][],
      logo: settings?.logo ?? "",
  ...
  const currencyValidationError = errors.currency?.message?.toString() || ''
      ...
      <div className="flex flex-wrap pb-8 border-b border-dashed border-border-base my-5 sm:my-8">
        ...
        <Card className="w-full sm:w-8/12 md:w-2/3">
          ...
          <div className="mb-5">
            ...
            <ValidationError message={t(currencyValidationError)} />
          </div>
