...
function SelectTypes({
  ...
  const errMsg =
    errors.type?.message === "string" ? t(errors.type?.message) : undefined;
  return (
    <div className="mb-5">
      ...
      <SelectInput
        ...
        isLoading={loading}
      />
      <ValidationError message={errMsg} />
    </div>
  );
}

export const updatedIcons = tagIcons.map((item: any, idx) => {
  item.label = (
    <div key={idx} className="flex space-s-5 items-center">
