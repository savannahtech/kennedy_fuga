...
export default function OrderDetailsPage() {
  ...
  const validationErrorMessage = errors?.order_status?.message?.toString() || ''
  return (
    <Card>
      <div className="flex flex-col lg:flex-row items-center">
        ...
        >
          <div className="w-full me-5 z-20">
            ...
            <ValidationError message={t(validationErrorMessage)} />
          </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between">
        <div className="w-full sm:w-1/2 sm:pe-8 mb-10 sm:mb-0">
          ...
          <div className="text-sm text-body flex flex-col items-start space-y-1">
            <span>{data?.order?.customer?.first_name}</span>
